...
import { dataItemCalendar, siaranSocialLinks } from "../../contentData";
        ...
        <div className=" py-12 px-[18px] md:px-20  md:flex md:justify-center print:py-0">
            <div className="flex flex-col gap-6 max-w-[825px]">
                ...
                <div className="flex flex-col gap-3 md:px-10">
                    <span className={
                        clx("text-sm font-semibold text-success-700")}>
                        Acara
                    </span>
                    <p className=" text-2xl font-semibold">{calendarItem.title}</p>

                    <div className=" flex flex-row gap-2 text-bg-black-500">
                        <div className=" flex flex-row gap-1 items-center"><ClockIcon /> Bacaan {calendarItem.readTime}</div>
                        .
                ...
                <div className="flex flex-col gap-3">
                    ...
                    />
                    <span className="text-bg-black-500 text-center">Image from {calendarItem.link}</span>
                </div>

                <p className=" text-2xl font-semibold md:px-10">{calendarItem.description}</p>
