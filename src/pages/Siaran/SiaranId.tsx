  ...
  return (
    <div className="py-12 justify-center print:py-0 mx-auto px-4.5 flex w-full relative md:px-6 max-w-screen-xl">
      {contents && (
        <>
          <HelmetMeta
            title={`${contents.title || "Berita"} - SekolahKu`}
            description="Berita daripada Kementerian Pendidikan Malaysia"
            canonical={`${domain}/${lang}/berita-kpm/${id}`}
            ogImage={contents.imageHero?.url}
            ogType="article"
          />
