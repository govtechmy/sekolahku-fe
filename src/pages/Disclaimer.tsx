export default function DisclaimerPage() {
  return (
    ...
    <div className="flex flex-col gap-6 max-w-[825px]">
      ...
      <p className="text-sm" {...{ "splwpk-privacy-policy": "splwpk-privacy-policy" }}>
        Penafian: Maklumat yang terkandung dalam laman web ini adalah untuk tujuan maklumat sahaja.
      </p>
      <p>Kementerian Pendidikan Malaysia tidak bertanggungjawab terhadap sebarang kehilangan atau kerosakan yang dialami kerana menggunakan maklumat dalam portal ini.</p>
      </div>
    </div>
  )
}
